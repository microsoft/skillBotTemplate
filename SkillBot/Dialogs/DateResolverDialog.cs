...
namespace Microsoft.Bot.Samples.SkillBot.Dialogs
{
    ...
    {
        private const string PromptMsgText = "<Replace this with your skill date prompt>";
        ...
        private static Task<bool> DateTimePromptValidator(PromptValidatorContext<IList<DateTimeResolution>> promptContext, CancellationToken cancellationToken)
        {
            if (promptContext.Recognized.Succeeded)
            {
                ...
                var isDefinite = new TimexProperty(timex).Types.Contains(Constants.TimexTypes.Definite) || new TimexProperty(timex).Types.Contains(Constants.TimexTypes.DateRange);
